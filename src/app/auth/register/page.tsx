 ...
 *              Soporta Registro con Email/Contraseña y Autenticación con Google OAuth 2.0.
 * 
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 text-gray-900 dark:text-slate-100 relative">
      {/* Botón de retorno al Marketplace */}
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white dark:bg-slate-900 py-8 px-6 shadow-2xs rounded-3xl border border-gray-200/90 dark:border-slate-800 space-y-6">
          ...
          {/* Botón de Registro con Google (OAuth 2.0) */}
          <button
            type="button"
            onClick={reg.handleGoogleLogin}
            disabled={reg.loading}
            className="w-full py-3.5 px-4 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-750 text-gray-800 dark:text-slate-100 rounded-2xl font-extrabold text-xs transition shadow-2xs flex items-center justify-center gap-3 cursor-pointer disabled:opacity-50"
          >
          ...
          <div className="relative flex items-center justify-center my-4">
            ...
            <span className="bg-white dark:bg-slate-900 px-3 text-[10px] uppercase font-bold text-gray-400 shrink-0">
